...
try{
    ...
    $stmt = $pdo->prepare('SELECT t.id, t.nome, t.descricao, p.nome as trabalhoNome FROM trabalho t inner join plano p on t.id_plano=p.id  WHERE t.id_cliente = :cliente');
