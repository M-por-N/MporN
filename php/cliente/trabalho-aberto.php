...
try{
    ...
    $stmt = $pdo->prepare('SELECT t.id, t.nome as trabalhoNome, t.descricao, p.nome as planoNome FROM trabalho t inner join planos p on t.plano=p.id  WHERE t.id_cliente = :cliente AND t.situacao = 0');
