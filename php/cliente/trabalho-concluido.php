...
try{
    ...
    $stmt = $pdo->prepare('SELECT t.nome, t.descricao, p.nome as trabalhoNome FROM trabalho t inner join planos p on t.plano=p.id  WHERE t.id_cliente = :cliente AND t.situacao = 2');
