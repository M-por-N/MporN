app.controller("EditarAdminController", function($scope, close, usuario, toastr, SweetAlert, EditarService, StatusService) {
   ...
   $scope.atualizaDados = function() {
      ...
      EditarService.editarAdmin($scope.usuario).then(function(data) {
         if (data.resultado) {
