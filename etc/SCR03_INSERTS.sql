...
INSERT INTO trabalho VALUES (1,'Bracomal Pneus',1,'Apresentação da Empresa',1,NULL,1,'Trabalho todo detalhado aqui!'),(2,'Site de Loja de Tecnologia',1,'Apresentação da Empresa',2,NULL,1,'Trabalho todo detalhado aqui!'),(3,'E-commerce',3,'Loja de Vendas ONline',3,NULL,1,'Trabalho todo detalhado aqui!'),(4,'Luiza Alimentos',1,'Site para apresentar a empresa',1,1,1,'Trabalho todo detalhado aqui!'),(6,'Site Fui Feito',2,'Site que já foi feito',2,1,2,'Trabalho todo detalhado aqui!'),(7,'Site Já feito Também',1,'Outro site já feito',3,1,2,'Trabalho todo detalhado aqui!'),(8,'Novo Trabalho Bracobum',1,'Site para apresentação da Empresa',4,NULL,1,'Descrição detalhada Aqui!'),(9,'Novo Trabalho 2',1,'Descricao pequena',4,1,3,'Descricao detalhada');
UNLOCK TABLES;
